...
export const serviceItems = [
  {
    ...
    text: "A br2and is a name, term, design, lorem ipsum symbol or any other feature that identifies one seller's good or service as distinct from those of other sellers.",
  },
  {
    iconPath:
...
export const services6 = [
  {
    width: 48,
    height: 64,
    path: "M16 18.75l32 32-4.25 4.25-32-32z...",
    titleKey: "consultingPage.services.items.0.title",
    textKey: "consultingPage.services.items.0.text",
  },
  {
    width: 60,
    height: 64,
    path: "M60 48h-22v2h8v2h-32.125v-2h8v-2h-21.875v-36h60v36zM2 14v32h56v-32h-56z",
    titleKey: "consultingPage.services.items.1.title",
    textKey: "consultingPage.services.items.1.text",
  },
  {
    width: 50,
    height: 64,
    path: "M0 11h50v42h-50v-42z...",
    titleKey: "consultingPage.services.items.2.title",
    textKey: "consultingPage.services.items.2.text",
  },
  {
    width: 48,
    height: 64,
    path: "M24.125 20c3.25 0 6.25 1.25 8.5 3.5s3.5 5.25...",
    titleKey: "consultingPage.services.items.3.title",
    textKey: "consultingPage.services.items.3.text",
  },
  {
    width: 48,
    height: 64,
    path: "M44.25 20c2.25 0 3.75 1.625 3.75 3.875v22...",
    titleKey: "consultingPage.services.items.4.title",
    textKey: "consultingPage.services.items.4.text",
  },
  {
    width: 36,
    height: 64,
    path: "M4 20v-8h28v8h-28zM6 14v4h24v-4h-24z...",
    titleKey: "consultingPage.services.items.5.title",
    textKey: "consultingPage.services.items.5.text",
  },
];
