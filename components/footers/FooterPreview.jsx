    ...
    <div className="container">
      <div className="row pb-120 pb-sm-80 pb-xs-50">
        <div className="col-md-4 col-lg-3 text-gray mb-sm-50">
          ...
          <p>
            JoinBits builds scalable software, cloud platforms,
            and automation solutions designed for performance,
            security, and long-term growth.
          </p>
          <div className="clearlinks">
            <strong>E.</strong>
            <a href="mailto:ibthemes21@gmail.com">contact@joinbitstech.com</a>
          </div>
        </div>
      ...
      <b>© Joinbits {new Date().getFullYear()}.</b>
          {/* Back to Top Link */}
          <div
