          ...
          >
            ...
            <SwiperSlide className="owl-item">
              <div className="features-item">
                ...
                <div className="features-title">{t("features.items.1.title")}</div>
                <div className="features-descr">{t("features.items.1.description")}</div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className="owl-item">
              <div className="features-item">
                ...
                <div className="features-title">{t("features.items.2.title")}</div>
                <div className="features-descr">{t("features.items.2.description")}</div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className="owl-item">
              <div className="features-item">
                ...
                <div className="features-title">{t("features.items.3.title")}</div>
                <div className="features-descr">{t("features.items.3.description")}</div>
              </div>
            </SwiperSlide>
            ...
            <div className="owl-controls clickable">
              ...
              <div className="owl-buttons">
                <div className="owl-prev snbp3" role="button" tabIndex="0">
                  <span className="visually-hidden">{t("features.prev")}</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="27px"
                    height="57px"
                ...
                <div className="owl-next snbn3" role="button" tabIndex="0">
                  <span className="visually-hidden">{t("features.next")}</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="27px"
                    height="57px"
