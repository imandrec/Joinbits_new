  ...
  return (
    <div className="row g-0 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div className="contact-1-left light-content">
          <div className="p-4 p-md-5">
            ...
            <div className="contact-1-link">
              ...
              <a href="tel:+8183776528800">Call now</a>
            </div>
          </div>
      ...
      <div className="col-lg-7 d-flex align-items-stretch">
        <div className="contact-1-right p-4 p-md-5">
          {/* Contact Form */}
          <form
          ...
          >
            ...
            <div className="pt-20">
              <button
                className="submit_btn btn btn-mod btn-large btn-circle btn-hover-anim btn-full"
                id="submit_btn"
